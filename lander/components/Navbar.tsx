...
export const Navbar: React.FC<NavbarProps> = ({ isDark, toggleTheme, currentView, setView }) => {
  ...
  return (
    <nav className="fixed w-full z-50 top-0 start-0 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md transition-colors duration-300">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <button onClick={() => setView('home')} className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
