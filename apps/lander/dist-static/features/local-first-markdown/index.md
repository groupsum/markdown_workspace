...
MdWrk is a local-first Markdown workspace that keeps authoring centered on portable Markdown files, browser-managed workspace state, and explicit export or sync boundaries.
...
### What does local-first mean for MdWrk?

Local-first means the product documentation treats local writing and preview as the default mental model, while sync, export, and external integrations are opt-in workflows.
