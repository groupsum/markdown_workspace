...
const EXPORT_STYLE_OVERRIDES = `
  ...
  .export-shell--plain body.markdown-export {
    background: #ffffff;
    color: #111111;
...
export const createHtmlExport = ({
  ...
  return createHtmlDocument({
    ...
    bodyHtml: `
  <main class="export-shell export-shell--${workspacePreferences.htmlExportBackground}" data-markdown-html-handling="${escapeHtml(htmlHandling)}">
    ${advisoryHtml}
