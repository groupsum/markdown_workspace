          ...
          <div className="settings-content">
            ...
            {activeTab === 'data' && (
               <>
                 ...
                 <div className="flex flex-col gap-4">
                    <div className="border-[var(--border-width)] border-[var(--border-color)] p-4 bg-[var(--bg-inset)]">
                    ...
                    <div className="border-[var(--border-width)] border-[var(--border-color)] p-4 opacity-50 cursor-not-allowed">
                       <div className="flex justify-between items-start mb-2">
