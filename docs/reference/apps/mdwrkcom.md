...
- package README: `apps/mdwrkcom/README.md`
...
- it should not use its on-site docs to document `@mdwrk/mdwrkcom` itself as the primary product
...
- config surface doc: `docs/apps/mdwrkcom-app.md`
- dependency boundary map: `docs/reference/package-boundary-map.md`
- deploy / release doc: `docs/apps/mdwrkcom-app.md`
