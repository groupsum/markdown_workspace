            ...
            const extension = {
                ...
                async activate(context) {
                    ...
                    context.registerSettingsSection({
                        ...
                        render: () => (_jsx(ExtensionManagerSettingsPanel, { runtime: options.runtime, open: () => context.host.views.open(EXTENSION_MANAGER_VIEW_ID), formatLabel: context.host.i18n.format })),
                    });
