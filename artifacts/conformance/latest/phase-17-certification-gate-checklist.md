# Phase 17 certification gate checklist

## Gate B — certification closure from RC artifacts

- [ ] Close the full official CommonMark lane (360/652 passing, 292 failing).
- [ ] Close the full official GFM lane (370/672 passing, 302 failing).
