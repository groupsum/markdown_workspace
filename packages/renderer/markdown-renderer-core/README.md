...
- Install compatibility remains on the same npm package name: `@mdwrk/markdown-renderer-core`.
- Repository source of truth: [https://github.com/groupsum/mdwrk/tree/master/packages/renderer/markdown-renderer-core](https://github.com/groupsum/mdwrk/tree/master/packages/renderer/markdown-renderer-core)
