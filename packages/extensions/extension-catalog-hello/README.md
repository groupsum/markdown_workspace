...
- Install compatibility remains on the same npm package name: `@mdwrk/extension-catalog-hello`.
- Repository source of truth: [https://github.com/groupsum/mdwrk/tree/master/packages/extensions/extension-catalog-hello](https://github.com/groupsum/mdwrk/tree/master/packages/extensions/extension-catalog-hello)
