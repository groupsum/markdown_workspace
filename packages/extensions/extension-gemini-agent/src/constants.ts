...
export const GEMINI_AGENT_SETTING_ENDPOINT = "endpoint" as const;
...
export const GEMINI_AGENT_SETTING_AUTO_ATTACH_DOCUMENT = "autoAttachDocument" as const;
export const GEMINI_AGENT_SETTING_AUTO_ATTACH_SELECTION = "autoAttachSelection" as const;
export const GEMINI_AGENT_SETTING_ALLOW_WRITEBACK = "allowWriteBack" as const;

export const GEMINI_AGENT_DEFAULT_SETTINGS: GeminiAgentResolvedSettings = {
...
export const GEMINI_AGENT_INTENTS: readonly GeminiAgentIntent[] = [
  "idle",
