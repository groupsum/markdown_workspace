...
- Install compatibility remains on the same npm package name: `@mdwrk/extension-gemini-agent`.
- Repository source of truth: [https://github.com/groupsum/mdwrk/tree/master/packages/extensions/extension-gemini-agent](https://github.com/groupsum/mdwrk/tree/master/packages/extensions/extension-gemini-agent)
