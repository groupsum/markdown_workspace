...
export const EXTENSION_MANAGER_EXPLORER_VIEW_ID = `${EXTENSION_MANAGER_EXTENSION_ID}.explorer`;
export const EXTENSION_MANAGER_MODULE_ID = `${EXTENSION_MANAGER_EXTENSION_ID}.module`;
