...
export const extensionManagerEsCatalog: ExtensionLocaleCatalog = {
  ...
  messages: {
    ...
    "view.card.labels.entryId": "ID_ENTRADA",
    "view.card.labels.catalogId": "ID_CATALOGO",
    ...
    "settings.shortcut.kicker": "ADMINISTRADOR_DE_EXTENSIONES",
    ...
    "settings.chips.paneOnly": "SOLO_PANEL",
    "settings.chips.splitSingle": "DIVIDIDO + UNICO",
    "settings.chips.settingsContent": "CONTENIDO_CONFIG",
    "settings.chips.englishFallback": "RESPALDO_EN",
    "settings.actions.openManager": "ABRIR_ADMINISTRADOR",
    "view.tree.chip": "NAVEGADOR_EXTENSIONES",
