...
const host = {
  ...
  workspace: { async listProjects() { return []; }, async listFiles() { return []; }, async getActiveProject() { return { id: 'project', name: 'Project' }; }, async getActiveFile() { return null; }, async readFile() { return ''; }, async writeFile() {} },
  i18n: {
