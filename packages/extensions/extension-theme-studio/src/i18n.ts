...
export const themeStudioLabels = {
  ...
  settingsShortcutKicker: themeStudioLabel("settings.shortcut.kicker", "THEME_STUDIO"),
  ...
  settingsStatsThemeId: themeStudioLabel("settings.stats.themeId", "THEME_ID"),
  ...
  settingsChipPaneOnly: themeStudioLabel("settings.chips.paneOnly", "PANE_ONLY"),
  settingsChipSplitSingle: themeStudioLabel("settings.chips.splitSingle", "SPLIT + SINGLE"),
  settingsChipSettingsContent: themeStudioLabel("settings.chips.settingsContent", "SETTINGS_CONTENT"),
  settingsChipEnglishFallback: themeStudioLabel("settings.chips.englishFallback", "EN_FALLBACK"),
  settingsOpenStudio: themeStudioLabel("settings.actions.openStudio", "OPEN_STUDIO"),
  panelKicker: themeStudioLabel("panel.kicker", "THEME_STUDIO"),
  browserChip: themeStudioLabel("browser.chip", "THEME_BROWSER"),
  ...
  browserTokenTitle: themeStudioLabel("browser.tokens.title", "TOKEN_BROWSER"),
  browserRelationshipTitle: themeStudioLabel("browser.relationships.title", "RELATIONSHIP_BROWSER"),
