...
export const ThemeStudioView: React.FC<ThemeStudioViewProps> = ({ service, close, formatLabel }) => {
  ...
  return (
    <div className="settings-modal-backdrop" role="presentation">
      <div className="settings-modal-shell" role="dialog" aria-modal="true" aria-label={formatLabel(themeStudioLabels.viewTitle)}>
          ...
          <div className="settings-card settings-card-stack" style={{ display: "grid", gap: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                ...
                <button className="modal-btn modal-btn-primary" onClick={() => void runExport()} disabled={snapshot.busy}><Package size={14} /> {formatLabel(themeStudioLabels.actionExport)}</button>
              </div>
            </div>
            ...
            <div className="settings-grid-2">
              <div style={{ display: "grid", gap: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  {exports && <button className="modal-btn" onClick={() => downloadTextFile(`${snapshot.metadata.themeId}.json`, exports.json, "application/json") }><Download size={14} /> {formatLabel(themeStudioLabels.actionDownloadJson)}</button>}
                </div>
              ...
              <div style={{ display: "grid", gap: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  {exports && <button className="modal-btn" onClick={() => downloadTextFile(`${snapshot.metadata.themeId}.css`, exportTarget === "host" ? exports.hostCss : exportTarget === "renderer" ? exports.rendererCss : exports.editorCss, "text/css") }><Download size={14} /> {formatLabel(themeStudioLabels.actionDownloadCss)}</button>}
                </div>
            ...
            <div style={{ display: "grid", gap: 8 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                {exports && <button className="modal-btn" onClick={() => downloadTextFile(`${snapshot.metadata.themeId}.theme-package.json`, JSON.stringify(exports.packageArtifact, null, 2), "application/json") }><Download size={14} /> {formatLabel(themeStudioLabels.actionDownloadPackage)}</button>}
              </div>
