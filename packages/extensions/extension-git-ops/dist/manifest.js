import { GIT_OPS_COMMAND_REFRESH_ID, GIT_OPS_COMMAND_TOGGLE_ID, GIT_OPS_EXPLORER_VIEW_ID, GIT_OPS_EXTENSION_ID, GIT_OPS_MODULE_ID, GIT_OPS_PRIMARY_VIEW_ID, GIT_OPS_RAIL_ID, GIT_OPS_SETTINGS_SECTION_ID, } from "./constants.js";
import { GIT_OPS_VERSION } from "./version.js";
const label = (defaultMessage, key) => ({ defaultMessage, key });
export const gitOpsManifest = {
    manifestVersion: 1,
