...
export const EXTENSION_ACTIVATION_STATE_KEY_SUFFIX = "active";
...
export const getExtensionActivationStateKey = (extensionId) => `ext:${extensionId}:${EXTENSION_ACTIVATION_STATE_KEY_SUFFIX}`;
