...
export const EXTENSION_ACTIVE_STATE_KEY_SUFFIX = "active" as const;
...
export const getExtensionActiveStateKey = (extensionId: string): string => `ext:${extensionId}:${EXTENSION_ACTIVE_STATE_KEY_SUFFIX}`;
