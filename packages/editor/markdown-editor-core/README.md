...
- Install compatibility remains on the same npm package name: `@mdwrk/markdown-editor-core`.
- Repository source of truth: [https://github.com/groupsum/mdwrk/tree/master/packages/editor/markdown-editor-core](https://github.com/groupsum/mdwrk/tree/master/packages/editor/markdown-editor-core)
